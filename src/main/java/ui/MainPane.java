...
import static ui.Window.currChart;
import static ui.Window.slider;
...
class MainPane extends JPanel {
    ...
    private class LeftPan extends JPanel {
        ...
        public void repaint() {
            ...
            if (Tin != null) {
                Tin.setText(String.format("tвн. = %+2.1f ˚C", Window.parser.getTemperaturesArray()[currChart][0]));
            }
